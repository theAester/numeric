...
extern int node_dsolve_euler(double (*F)(double, double, void*), void*, double, double, double, int, double*);
extern double node_dstep_euler(double (*F)(double x, double y, void* arg), void*, double, double, double);
